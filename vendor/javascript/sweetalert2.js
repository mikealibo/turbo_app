// sweetalert2@11.19.1 downloaded from https://ga.jspm.io/npm:sweetalert2@11.19.1/dist/sweetalert2.all.js
...
/**
   ...
   */
/** @type {SwalClass[]} */const s=["container","shown","height-auto","iosfix","popup","modal","no-backdrop","no-transition","toast","toast-shown","show","hide","close","title","html-container","actions","confirm","deny","cancel","footer","icon","icon-content","image","input","file","range","select","radio","checkbox","label","textarea","inputerror","input-label","validation-message","progress-steps","active-progress-step","progress-step","progress-step-line","loader","loading","styled","top","top-start","top-end","top-left","top-right","center","center-start","center-end","center-left","center-right","bottom","bottom-start","bottom-end","bottom-left","bottom-right","grow-row","grow-column","grow-fullscreen","rtl","timer-progress-bar","timer-progress-bar-container","scrollbar-measure","icon-success","icon-warning","icon-info","icon-question","icon-error","draggable","dragging"];const a=s.reduce(((e,t)=>{e[t]=n+t;return e}),/** @type {SwalClasses} */{});
...
/**
   ...
   * @param {SweetAlertOptions} params
   */function handleButtonsStyling(e,t,o,n){if(n.buttonsStyling){addClass([e,t,o],a.styled);n.confirmButtonColor&&e.style.setProperty("--swal2-confirm-button-background-color",n.confirmButtonColor);n.denyButtonColor&&t.style.setProperty("--swal2-deny-button-background-color",n.denyButtonColor);n.cancelButtonColor&&o.style.setProperty("--swal2-cancel-button-background-color",n.cancelButtonColor);applyOutlineColor(e);applyOutlineColor(t);applyOutlineColor(o)}else removeClass([e,t,o],a.styled)}
/**
   * @param {HTMLElement} button
   */function applyOutlineColor(e){const t=window.getComputedStyle(e);const o=t.backgroundColor.replace(/rgba?\((\d+), (\d+), (\d+).*/,"rgba($1, $2, $3, 0.5)");e.style.setProperty("--swal2-action-button-outline",t.getPropertyValue("--swal2-outline").replace(/ rgba\(.*/,` ${o}`))}
/**
   * @param {HTMLElement} button
...
/**
   ...
   */const setFocus=(e,t)=>{var o;const n=getFocusableElements();if(n.length){e+=t;e===-2&&(e=n.length-1);e===n.length?e=0:e===-1&&(e=n.length-1);n[e].focus()}else(o=getPopup())===null||o===void 0||o.focus()};const C=["ArrowRight","ArrowDown"];const A=["ArrowLeft","ArrowUp"];
/**
   * @param {SweetAlertOptions} innerParams
